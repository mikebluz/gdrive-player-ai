    ...
    const PROGRESSIONS = {
      major: [
        ...
        { name: 'I — IV — V — IV (Classic rock)',      steps: [[1,'maj'],[4,'maj'],[5,'maj'],[4,'maj']] },
        { name: 'I — ii — IV — V',                     steps: [[1,'maj'],[2,'min'],[4,'maj'],[5,'maj']] },
        { name: 'I — iii — vi — IV',                   steps: [[1,'maj'],[3,'min'],[6,'min'],[4,'maj']] },
        { name: 'I — V — ii — IV',                     steps: [[1,'maj'],[5,'maj'],[2,'min'],[4,'maj']] },
        { name: 'IV — V — iii — vi (Royal road)',      steps: [[4,'maj7'],[5,'7'],[3,'min7'],[6,'min']] },
        { name: 'IV — V — I — vi',                     steps: [[4,'maj'],[5,'maj'],[1,'maj'],[6,'min']] },
        { name: 'ii — IV — I — V',                     steps: [[2,'min'],[4,'maj'],[1,'maj'],[5,'maj']] },
        { name: 'I — vi — ii — IV (Doo-wop var.)',     steps: [[1,'maj'],[6,'min'],[2,'min'],[4,'maj']] },
        { name: 'vi — V — IV — V (Building)',          steps: [[6,'min'],[5,'maj'],[4,'maj'],[5,'maj']] },
        { name: 'I — IV (Two-chord jam)',              steps: [[1,'maj'],[4,'maj']] },
        { name: 'Imaj7 — ii7 (Sunday vamp)',           steps: [[1,'maj7'],[2,'min7']] },
        { name: 'iii — IV (Dreamy vamp)',              steps: [[3,'min'],[4,'maj']] },
        { name: 'I — I7 — IV — iv (Gospel)',           steps: [[1,'maj'],[1,'7'],[4,'maj'],[4,'min']] },
        { name: 'Imaj9 — iii7 — vi9 — ii9 (Neo-soul)', steps: [[1,'maj9'],[3,'min7'],[6,'min9'],[2,'min9']] },
        { name: 'Imaj7 — vi7 — IVmaj7 — V9 (Smooth)',  steps: [[1,'maj7'],[6,'min7'],[4,'maj7'],[5,'9']] },
        { name: 'I — Imaj7 — I6 (Cliché line)',        steps: [[1,'maj'],[1,'maj7'],[1,'6']] },
        { name: 'ii — V — iii — vi (Jazz ladder)',     steps: [[2,'min7'],[5,'7'],[3,'min7'],[6,'min7']] },
        { name: 'I — IV — ii — V (Gospel turnaround)', steps: [[1,'maj7'],[4,'maj7'],[2,'min7'],[5,'7']] },
        { name: 'I — V — IV — I (Full circle)',        steps: [[1,'maj'],[5,'maj'],[4,'maj'],[1,'maj']] },
        { name: 'Isus2 — IV — Vsus4 — V (Open rock)',  steps: [[1,'sus2'],[4,'maj'],[5,'sus4'],[5,'maj']] },
      ],
      minor: [
        ...
        { name: 'i — v — VI — VII',                    steps: [[1,'min'],[5,'min'],[6,'maj'],[7,'maj']] },
        { name: 'i — VII — v — VI',                    steps: [[1,'min'],[7,'maj'],[5,'min'],[6,'maj']] },
        { name: 'VI — VII — i (Epic rise)',            steps: [[6,'maj'],[7,'maj'],[1,'min']] },
        { name: 'i — VII — VI — iv',                   steps: [[1,'min'],[7,'maj'],[6,'maj'],[4,'min']] },
        { name: 'i — iv — VI — V',                     steps: [[1,'min'],[4,'min'],[6,'maj'],[5,'maj']] },
        { name: 'i — III — VI — VII',                  steps: [[1,'min'],[3,'maj'],[6,'maj'],[7,'maj']] },
        { name: 'i7 — iv7 (Minor vamp)',               steps: [[1,'min7'],[4,'min7']] },
        { name: 'i9 — iv9 (Neo-soul minor)',           steps: [[1,'min9'],[4,'min9']] },
        { name: 'i — VI (Two-chord lament)',           steps: [[1,'min'],[6,'maj']] },
        { name: 'i — III — VII — VI (Descent)',        steps: [[1,'min'],[3,'maj'],[7,'maj'],[6,'maj']] },
        { name: 'iv — VI — i — VII',                   steps: [[4,'min'],[6,'maj'],[1,'min'],[7,'maj']] },
        { name: 'i — VI — III — iv',                   steps: [[1,'min'],[6,'maj'],[3,'maj'],[4,'min']] },
      ],
      dorian: [
        ...
        { name: 'i7 — IV7 (Funk vamp)',                steps: [[1,'min7'],[4,'7']] },
        { name: 'i7 — ii7 (So-What vamp)',             steps: [[1,'min7'],[2,'min7']] },
        { name: 'i — IV — VII — IV',                   steps: [[1,'min'],[4,'maj'],[7,'maj'],[4,'maj']] },
      ],
      phrygian: [
        ...
        { name: 'i7 — II (Dark vamp)',                 steps: [[1,'min7'],[2,'maj']] },
        { name: 'i — II — VI — II',                    steps: [[1,'min'],[2,'maj'],[6,'maj'],[2,'maj']] },
      ],
      lydian: [
        ...
        { name: 'Imaj7 — II7 (Floating)',              steps: [[1,'maj7'],[2,'7']] },
        { name: 'I — II — iii — II',                   steps: [[1,'maj'],[2,'maj'],[3,'min'],[2,'maj']] },
      ],
      mixolydian: [
        ...
        { name: 'I7 — IV (Blues vamp)',                steps: [[1,'7'],[4,'maj']] },
        { name: 'I — VII — v — IV',                    steps: [[1,'maj'],[7,'maj'],[5,'min'],[4,'maj']] },
      ],
      'harmonic minor': [
        ...
        { name: 'i — ii° — V7 — i',                    steps: [[1,'min'],[2,'dim'],[5,'7'],[1,'min']] },
        { name: 'i — V7 — VI — V7 (Suspense)',         steps: [[1,'min'],[5,'7'],[6,'maj'],[5,'7']] },
        { name: 'iv — V7 — i (Gypsy cadence)',         steps: [[4,'min'],[5,'7'],[1,'min']] },
      ],
      'melodic minor': [
        ...
        { name: 'i6 — ii7 (Smooth minor)',             steps: [[1,'m6'],[2,'min7']] },
        { name: 'iminMaj7 — IV7 (Noir vamp)',          steps: [[1,'minMaj7'],[4,'7']] },
      ],
    };
